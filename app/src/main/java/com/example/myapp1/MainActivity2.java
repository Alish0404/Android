...
public class MainActivity2 extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logoutIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                logout(); // Вызов метода для выхода
            }
        });

        client = LocationServices.getFusedLocationProviderClient(this);

        if (ActivityCompat.checkSelfPermission(MainActivity2.this, ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            if (ActivityCompat.shouldShowRequestPermissionRationale(MainActivity2.this, ACCESS_FINE_LOCATION)) {
                ActivityCompat.requestPermissions(MainActivity2.this, new String[]{ACCESS_FINE_LOCATION}, 1);
            } else {
                ActivityCompat.requestPermissions(MainActivity2.this, new String[]{ACCESS_FINE_LOCATION}, 1);
            }
        }
    ...
    // Метод для выхода
    private void logout() {
        // Очистка данных сессии (если используется SharedPreferences)
    ...
    public boolean onMenuItemClick(MenuItem item) {
        ...
        if (itemId == R.id.id_currentLocation) {
            ...
            return true;
        } else if (itemId == R.id.id_profile) {  // Condition for Profile
            openProfile();  // Call openProfile to open ProfileActivity
            return true;
        } else {
            return false;
        }
    ...
    public void openProfile() {
        Intent intent = new Intent(MainActivity2.this, Profile.class); // Ensure correct class name if it's ProfileActivity
        startActivity(intent); // Navigates to ProfileActivity
    }
